...
const s = {
  ...
  card:           { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,119,255,0.15)', borderRadius: 10, padding: 20, marginBottom: 20 },
  cardTitle:      { fontSize: 15, fontWeight: 700, color: '#e2e8f0', marginBottom: 14 },
  countBadge:     { fontSize: 12, background: 'rgba(0,119,255,0.2)', color: '#94b4d4', padding: '2px 8px', borderRadius: 10, marginLeft: 8 },
  formRow:        { display: 'flex', gap: 10, alignItems: 'flex-start', flexWrap: 'wrap' },
  input:          { background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(0,119,255,0.25)', borderRadius: 7, padding: '8px 12px', color: '#e2e8f0', fontSize: 13, minWidth: 140 },
  ...
  multiSelect:    { background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(0,119,255,0.25)', borderRadius: 7, padding: '4px 8px', color: '#e2e8f0', fontSize: 13, minWidth: 180, height: 80 },
  btn:            { background: 'rgba(0,119,255,0.2)', border: '1px solid rgba(0,119,255,0.4)', color: '#e2e8f0', padding: '8px 16px', borderRadius: 7, cursor: 'pointer', fontSize: 13, fontWeight: 600, alignSelf: 'flex-end' },
  ...
  loading:        { color: '#94b4d4', padding: 20, textAlign: 'center' },
  ...
  username:       { fontSize: 14, color: '#e2e8f0', fontWeight: 600 },
  groupsCell:     { display: 'flex', flexWrap: 'wrap', gap: 6, alignItems: 'center' },
  groupTag:       { fontSize: 11, background: 'rgba(0,119,255,0.15)', border: '1px solid rgba(0,119,255,0.3)', color: '#94b4d4', padding: '2px 8px', borderRadius: 10, display: 'flex', alignItems: 'center', gap: 4 },
  removeBtn:      { background: 'none', border: 'none', color: '#64748b', cursor: 'pointer', fontSize: 13, padding: 0, lineHeight: 1 },
  addSelect:      { fontSize: 11, background: 'rgba(0,119,255,0.1)', border: '1px solid rgba(0,119,255,0.2)', color: '#94b4d4', borderRadius: 6, padding: '3px 8px', cursor: 'pointer' },
