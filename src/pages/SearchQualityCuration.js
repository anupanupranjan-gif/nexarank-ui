...
const s = {
  ...
  leftPanel:      { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,119,255,0.15)', borderRadius: 10, overflow: 'hidden' },
  setSection:     { padding: 12, borderBottom: '1px solid rgba(0,119,255,0.1)' },
  setHeader:      { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  setLabel:       { fontSize: 11, fontWeight: 700, color: '#94b4d4', textTransform: 'uppercase', letterSpacing: '0.05em' },
  newSetBtn:      { fontSize: 11, background: 'rgba(0,119,255,0.15)', border: '1px solid rgba(0,119,255,0.3)', color: '#94b4d4', padding: '3px 8px', borderRadius: 5, cursor: 'pointer' },
  newSetForm:     { display: 'flex', gap: 6, marginBottom: 8 },
  newSetInput:    { flex: 1, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(0,119,255,0.25)', borderRadius: 6, padding: '5px 8px', color: '#e2e8f0', fontSize: 12 },
  createSetBtn:   { background: 'rgba(0,119,255,0.2)', border: '1px solid rgba(0,119,255,0.4)', color: '#e2e8f0', padding: '5px 10px', borderRadius: 6, cursor: 'pointer', fontSize: 12 },
  ...
  setItemActive:  { background: 'rgba(0,119,255,0.15)', border: '1px solid rgba(0,119,255,0.3)' },
  setName:        { fontSize: 13, color: '#e2e8f0' },
  ...
  statsBar:       { display: 'flex', gap: 12, padding: '8px 12px', background: 'rgba(0,0,0,0.2)', borderBottom: '1px solid rgba(0,119,255,0.1)' },
  ...
  queryItemActive:{ background: 'rgba(0,119,255,0.15)', border: '1px solid rgba(0,119,255,0.3)' },
  queryItemJudged:{ opacity: 0.7 },
  queryText:      { fontSize: 13, color: '#e2e8f0' },
  ...
  rightPanel:     { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,119,255,0.15)', borderRadius: 10, minHeight: 400 },
  ...
  promptText:     { fontSize: 15, color: '#94b4d4', fontWeight: 600 },
  promptSub:      { fontSize: 13, color: '#475569' },
  resultHeader:   { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 20px', borderBottom: '1px solid rgba(0,119,255,0.1)' },
  resultQuery:    { fontSize: 14, color: '#e2e8f0' },
  gradeScale:     { display: 'flex', gap: 12 },
  gradeLegend:    { fontSize: 11 },
  loading:        { padding: 40, textAlign: 'center', color: '#94b4d4' },
  ...
  resultCard:     { display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(0,0,0,0.2)', borderRadius: 8, padding: '12px 14px' },
  resultRank:     { fontSize: 12, color: '#475569', fontWeight: 700, minWidth: 28, textAlign: 'center' },
  resultInfo:     { flex: 1, minWidth: 0 },
  resultTitle:    { fontSize: 14, color: '#e2e8f0', fontWeight: 500, marginBottom: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
