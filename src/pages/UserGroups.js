...
const s = {
  ...
  createBtn:    { background: 'rgba(0,119,255,0.2)', border: '1px solid rgba(0,119,255,0.4)', color: '#94b4d4', padding: '8px 16px', borderRadius: 7, cursor: 'pointer', fontSize: 13, fontWeight: 600 },
  ...
  groupCard:    { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(0,119,255,0.15)', borderRadius: 10, padding: 16 },
  groupHeader:  { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 },
  groupName:    { fontSize: 15, fontWeight: 700, color: '#e2e8f0' },
  groupDesc:    { fontSize: 12, color: '#64748b', marginTop: 2 },
  groupActions: { display: 'flex', gap: 6, alignItems: 'center' },
  editBtn:      { background: 'rgba(0,119,255,0.15)', border: '1px solid rgba(0,119,255,0.3)', color: '#94b4d4', padding: '3px 10px', borderRadius: 5, cursor: 'pointer', fontSize: 12 },
  ...
  permTag:      { fontSize: 10, background: 'rgba(0,119,255,0.1)', border: '1px solid rgba(0,119,255,0.2)', color: '#94b4d4', padding: '2px 6px', borderRadius: 4 },
  ...
  label:        { display: 'block', fontSize: 12, fontWeight: 600, color: '#94b4d4', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' },
  input:        { width: '100%', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(0,119,255,0.25)', borderRadius: 7, padding: '8px 12px', color: '#e2e8f0', fontSize: 14, boxSizing: 'border-box' },
  permCategory: { marginBottom: 12, background: 'rgba(0,0,0,0.2)', borderRadius: 8, padding: 10 },
  catHeader:    { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  catLabel:     { fontSize: 11, fontWeight: 700, color: '#94b4d4', textTransform: 'uppercase', letterSpacing: '0.1em' },
  ...
  checkText:    { fontSize: 13, color: '#e2e8f0' },
  modalFooter:  { display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 20 },
  cancelBtn:    { background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#94b4d4', padding: '8px 18px', borderRadius: 7, cursor: 'pointer' },
  saveBtn:      { background: 'rgba(0,119,255,0.25)', border: '1px solid rgba(0,119,255,0.4)', color: '#e2e8f0', padding: '8px 18px', borderRadius: 7, cursor: 'pointer', fontWeight: 600 },
};
