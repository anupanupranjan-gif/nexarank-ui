...
const s = {
  ...
  subtitle:        { fontSize: '13px', color: '#64748b', marginTop: '4px', lineHeight: '1.5' },
  ...
  sectionTab:      { padding: '10px 20px', border: 'none', background: 'none', cursor: 'pointer', fontSize: '14px', color: '#64748b', borderBottom: '2px solid transparent', marginBottom: '-2px' },
  sectionTabActive:{ color: '#4f46e5', borderBottom: '2px solid #4f46e5', fontWeight: 600 },
  formCard:        { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '24px' },
  ...
  input:           { padding: '9px 12px', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '14px', color: '#1e293b', background: 'white', outline: 'none' },
  ...
  lastTested:      { fontSize: '12px', color: '#94a3b8', marginTop: '4px' },
  fieldsHeader:    { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' },
  fieldsCount:     { fontSize: '14px', color: '#475569', fontWeight: 600 },
  ...
  td:              { padding: '10px 12px', borderBottom: '1px solid #f1f5f9', verticalAlign: 'middle', color: '#1e293b' },
  trEven:          { background: '#fafafa' },
  fieldName:       { fontFamily: 'monospace', fontWeight: 600, color: '#4f46e5' },
  typeBadge:       { background: '#ede9fe', color: '#5b21b6', padding: '2px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 600 },
  sampleValues:    { color: '#64748b', fontSize: '12px' },
