...
const s = {
  ...
  subtitle:       { fontSize: '13px', color: '#4a5568', marginTop: '4px' },
  ...
  empty:          { padding: '40px', textAlign: 'center', color: '#1e293b', fontSize: '14px', background: '#f1f5f9', borderRadius: '8px', lineHeight: '1.8' },
  runInfo:        { fontSize: '12px', color: '#4a5568', marginBottom: '16px' },
  ...
  scoreLabel:     { fontSize: '14px', fontWeight: 600, color: '#334155', marginBottom: '4px' },
  scoreHint:      { fontSize: '12px', color: '#475569' },
  section:        { marginBottom: '24px' },
  sectionTitle:   { fontSize: '15px', fontWeight: 600, color: '#1a202c', marginBottom: '12px' },
  ...
  td:             { padding: '10px 12px', borderBottom: '1px solid #e2e8f0', verticalAlign: 'middle', color: '#1e293b' },
  trEven:         { background: '#f1f5f9' },
  hybridBadge:    { background: '#2563eb', color: '#ffffff', padding: '3px 8px', borderRadius: '12px', fontSize: '12px', fontWeight: 600 },
  bm25Badge:      { background: '#64748b', color: '#ffffff', padding: '3px 8px', borderRadius: '12px', fontSize: '12px' },
  liftBadge:      { background: '#f0fdf4', color: '#16a34a', padding: '3px 8px', borderRadius: '10px', fontSize: '12px', fontWeight: 600 },
  baselineBadge:  { background: '#64748b', color: '#ffffff', padding: '3px 8px', borderRadius: '10px', fontSize: '12px' },
  intentBadge:    { background: '#7c3aed', color: '#ffffff', padding: '3px 8px', borderRadius: '12px', fontSize: '12px', fontWeight: 600, textTransform: 'capitalize' },
  barWrap:        { width: '120px', height: '8px', background: '#1a202c', borderRadius: '4px', overflow: 'hidden' },
