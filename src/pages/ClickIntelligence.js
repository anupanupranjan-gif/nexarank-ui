...
const s = {
  ...
  cardLabel:        { fontSize: '13px', fontWeight: 600, color: '#1e293b', marginBottom: '4px' },
  cardHint:         { fontSize: '11px', color: '#94a3b8' },
  ...
  queryBadge:       { background: '#ede9fe', color: '#5b21b6', padding: '3px 8px', borderRadius: '12px', fontSize: '12px', fontWeight: 600 },
  productTitle:     { maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', color: '#1e293b' },
  ctrBad:           { background: '#fef2f2', color: '#dc2626', padding: '2px 8px', borderRadius: '10px', fontSize: '12px', fontWeight: 600 },
  ctrGood:          { background: '#f0fdf4', color: '#16a34a', padding: '2px 8px', borderRadius: '10px', fontSize: '12px', fontWeight: 600 },
  positionBad:      { background: '#fff7ed', color: '#d97706', padding: '2px 8px', borderRadius: '10px', fontSize: '12px', fontWeight: 600 },
  opportunityBadge: { background: '#eff6ff', color: '#2563eb', padding: '2px 8px', borderRadius: '10px', fontSize: '12px' },
  ...
  empty:            { padding: '40px', textAlign: 'center', color: '#94a3b8', fontSize: '14px', background: '#f8fafc', borderRadius: '8px', lineHeight: '1.6' },
};
