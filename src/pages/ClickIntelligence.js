...
const s = {
  ...
  sectionTab:       { padding: '10px 20px', border: 'none', background: 'none', cursor: 'pointer', fontSize: '14px', color: '#4a5568', borderBottom: '2px solid transparent', marginBottom: '-2px' },
