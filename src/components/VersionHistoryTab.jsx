...
const vs = {
  ...
  card:         { background: '#0f1b33', border: '1px solid #1f3358', borderRadius: 8, overflow: 'hidden' },
  cardOpen:     { borderColor: '#3b82f6' },
  row:          { display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', cursor: 'pointer' },
  badge:        { background: '#1d4ed8', color: '#fff', fontWeight: 600, fontSize: 12, padding: '2px 10px', borderRadius: 999, minWidth: 36, textAlign: 'center' },
  currentTag:   { background: '#065f46', color: '#6ee7b7', fontSize: 11, padding: '2px 8px', borderRadius: 999 },
  note:         { flex: 1, color: '#e2e8f0', fontSize: 13 },
  meta:         { color: '#94a3b8', fontSize: 12 },
  chevron:      { color: '#64748b' },
  detail:       { padding: '0 16px 16px', borderTop: '1px solid #1f3358' },
  section:      { marginTop: 14 },
  sectionLabel: { color: '#94a3b8', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 },
  diffRow:      { display: 'grid', gridTemplateColumns: '140px 1fr 24px 1fr', gap: 8, alignItems: 'center', padding: '4px 0', fontSize: 13 },
  diffField:    { color: '#cbd5e1' },
  diffOld:      { color: '#fca5a5', background: '#7f1d1d33', padding: '2px 8px', borderRadius: 4 },
  diffArrow:    { color: '#64748b', textAlign: 'center' },
  diffNew:      { color: '#86efac', background: '#14532d33', padding: '2px 8px', borderRadius: 4 },
  snapshotGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 8 },
  snapshotCell: { background: '#0a1426', border: '1px solid #1f335880', borderRadius: 6, padding: '8px 10px', display: 'flex', flexDirection: 'column', gap: 2 },
  snapshotLabel:{ color: '#64748b', fontSize: 11 },
  snapshotValue:{ color: '#e2e8f0', fontSize: 13, wordBreak: 'break-all' },
  restoreBtn:   { marginTop: 14, background: '#1d4ed8', color: '#fff', border: 'none', borderRadius: 6, padding: '8px 16px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' },
  errorBanner:  { background: '#7f1d1d33', border: '1px solid #b91c1c', color: '#fca5a5', padding: '8px 12px', borderRadius: 6, fontSize: 13 },
